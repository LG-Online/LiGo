<!-- ANWENDUNG UND ZIEL -->
<!-- Anwenden des Stylesheets auf die bibliographie.xml-Datei (im xml_daten -> sonstige-Ordner) mit der LiGo-Bibliographie -->
...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="illustration">
        <!-- Iterieren über die Bibliographie-Abschnitte -->
        <xsl:for-each select="./LMMLtext">
            <!-- Umschließen jedes Abschnitts mit einem <div>-Blockelement und Vergeben einer ID für das Element, um über diese vom Inhaltsverzeichnis zum Abschnitt verlinken zu können -->
    ...
    <xsl:template match="bibliography">
        ...
        <li class="bib_entry">
            <!-- Einfügen des Autors (-> Wird fett dargestellt) -->
